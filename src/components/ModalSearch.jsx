      ...
      >
        ...
        >
          ...
          <form className="border-b border-gray-200 dark:border-gray-700/60">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search labs, researchers, reports, domains..."
              />
          ...
          <div className="py-4 px-2">
            ...
            {/* Recent Searches (Updated for Lab Records) */}
            <div className="mb-3 last:mb-0">
              ...
              <ul className="text-sm">
                ...
                <SearchItem label="AI Research Lab – Productivity Report" />
                <SearchItem label="Dr. Ayesha Khan – Workload Profile" />
                <SearchItem label="2023 Lab Success Rate Analysis" />
                <SearchItem label="Machine Learning Domain – Lab History" />
                <SearchItem label="Weekly Summary – Molecular Biology Lab" />

              </ul>
            </div>

            {/* Recent Pages (Updated for NexaCore Dashboard) */}
            <div className="mb-3 last:mb-0">
              <div className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase px-2 mb-2">
                Recent Pages
              </div>
              ...
              <ul className="text-sm">
                <PageItem title="Dashboard" desc="Overview / Analytics" />
                <PageItem title="Labs" desc="Lab Profiles / Performance" />
                <PageItem title="Researchers" desc="Profiles / Workload" />
                <PageItem title="Reports" desc="Weekly / Monthly Lab Reports" />
                <PageItem title="Insights" desc="AI-Generated Recommendations" />
              </ul>
            </div>
