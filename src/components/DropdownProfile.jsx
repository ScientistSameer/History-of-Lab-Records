...
function DropdownProfile({ align }) {
  ...
  // Simulated User (Replace with real JWT data later)
  const user = {
    name: "Sameer Babar",
    role: "Lab Manager",               // Lab Manager / Researcher / Admin
    lab: "Computational Research Lab"   // Lab Name
  };
      ...
      >
        ...
        >
          ...
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200 dark:border-gray-700/60">
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400 italic">{user.lab}</div>
          </div>
